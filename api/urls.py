...
from .views import VehicleList, ShipmentList, ShipmentDetail, RegisterView, UserProfileView, RegisterCompanyView, AddEmployeeView
...
urlpatterns = [
    ...
    path('company/add-employee/', AddEmployeeView.as_view(), name='add-employee'),
]